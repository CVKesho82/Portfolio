  ...
  return (
    <div className ="container">
        <CardGroup className="card"><h3>Technical <br></br> Writing {" "}</h3>
         ...
         <Card>
          <Card.Header as="h5">Process Flows
           ...
           <Card.Body>
           <Card.Img variant="top" height="50%" src={process}/>
        ...
        <Card>
          ...
          <Card.Body>
          <Card.Img variant="top" height="50%" src={onboard}/>
            <Card.Title></Card.Title>
            <Card.Text></Card.Text>
          </Card.Body>
        </Card>
        <Card>
          ...
          <Card.Body>
          <Card.Img variant="top" height="50%" src={manual}/>
            <Card.Title></Card.Title>
            <Card.Text></Card.Text>
          </Card.Body>
        </Card>
        <Card>
          ...
          <Card.Body>
          <Card.Img variant="top" height="50%" src={article}/>
            <Card.Title></Card.Title>
            <Card.Title></Card.Title>
            <Card.Text></Card.Text>
          </Card.Body>
